...
<img src='walkthroughSimpleTweet.gif' width='' alt='Video Walkthrough' />
...
**SimpeTweet part2** is an android app that allows a user to view his Twitter timeline and post a new tweet. The app utilizes [Twitter REST API](https://dev.twitter.com/rest/public).
